...
const CHANNEL_CONFIGS: ChannelConfig[] = [
  {
    ...
    description:
      'Connect your Telegram bot to chat with ClaraVerse directly from Telegram. Messages are processed through a secure webhook.',
    ...
    <div className="channels-section">
      <div className="channels-header">
        ...
        <p className="channels-description">
          Connect external messaging platforms to chat with ClaraVerse. Each channel creates a
